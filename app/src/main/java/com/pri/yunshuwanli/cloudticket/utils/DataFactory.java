    ...
    public static List<OrderInfo> saveListData2(Context context) {
        ...
        OrderInfo info = null;
            ...
            info = new OrderInfo("test_1", 10.00 ,
                    "2018-09-17 23:59:59", "沪C88812");
            dao.add(info);
           info = new OrderInfo("test_2", 10.00 ,
                "2018-09-16 23:59:59", "沪C88812");
        dao.add(info);
        info = new OrderInfo("test_3", 10.00 ,
                "2018-09-15 23:59:59", "沪C88812");
        dao.add(info);
        info = new OrderInfo("test_4", 10.00 ,
                "2018-09-18 00:30:00", "沪C88812");
        dao.add(info);

        info = new OrderInfo("test_5", 10.00 ,
                "2018-09-18 00:00:00", "沪C88812");
        dao.add(info);
        info = new OrderInfo("test_6", 10.00 ,
                "2018-09-18 23:59:59", "沪C88812");
        dao.add(info);
